    ...
    <div class="lg:hidden">
        {#each genreData as genre}
            <div class="mt-3 p-3 font-light rounded-md dark:text-gray-200 bg-black bg-opacity-5 dark:bg-white dark:bg-opacity-5">
                <div class="text-xl">{genre[0]}</div>
                <div class="mt-auto ml-auto">{genre[1].toLocaleString()} 작품</div>
                <div class="mt-2 grid grid-cols-2">
                    <div><span class="text-gray-600 dark:text-gray-400">조회수: </span>{genre[2].toLocaleString()}</div>
